...
export default function Invoice () {
    const { userInvoices }: any = useInvoices();
        ...
        <div className="mt-12 bg-white p-6 rounded-lg shadow-lg">
            ...
            <table className="min-w-full border-collapse">
                ...
                {userInvoices?.map((invoice: any, index: number) => (
                    ...
                    <svg onClick={() => handleViewInvoice(invoice)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-blue-600 inline-flex justify-end cursor-pointer">
