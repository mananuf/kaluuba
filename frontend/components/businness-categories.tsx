...
import Logo01 from "@/public/img/kaluuba-icon.png";
import Logo02 from "@/public/img/kaluuba-icon.png";
import Logo03 from "@/public/img/kaluuba-icon.png";
import Logo04 from "@/public/img/kaluuba-icon.png";
import Logo05 from "@/public/img/kaluuba-icon.png";
import Logo06 from "@/public/img/kaluuba-icon.png";
import Logo07 from "@/public/img/kaluuba-icon.png";
import Logo08 from "@/public/img/kaluuba-icon.png";
import Logo09 from "@/public/img/kaluuba-icon.png";
    ...
    <section className="overflow-clip">
      <div className="mx-auto max-w-xl px-4 sm:px-6">
        <div className="md:pb-16">
          {/* Tab panels */}
          <div className="relative flex h-[235px] items-center justify-center">
            {/* Small blue dots */}
