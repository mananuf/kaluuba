...
export default function DashboardLayout({children}: DashboardLayoutProps) {
    ...
    const { data: userData, isError, isSuccess, failureReason } = useReadContract({
        ...
        args: [address],
        // enabled: fetchUser && isConnected && !!address,
    });
                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    ...
                    <div className="flex items-center">
                        <div className="flex items-center ms-3">
                            <div>
                            <button type="button" className="flex text-sm bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-2 rounded-full focus:ring-4 focus:ring-gray-300" aria-expanded="false" data-dropdown-toggle="dropdown-user">
